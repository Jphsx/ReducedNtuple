...
#ifndef prod2018MC_NANO_DY_h
#define prod2018MC_NANO_DY_h
...
class prod2018MC_NANO_DY : public TSelector {
public :
   ...
   prod2018MC_NANO_DY(TTree * /*tree*/ =0) { }
   virtual ~prod2018MC_NANO_DY() { }
...
#ifdef prod2018MC_NANO_DY_cxx
void prod2018MC_NANO_DY::Init(TTree *tree)
{
...
Bool_t prod2018MC_NANO_DY::Notify()
{
...
#endif // #ifdef prod2018MC_NANO_DY_cxx
